  ...
  return data !== null ? (
    <Card className='invoice-preview-card'>
      <CardBody className='invoice-padding pb-0'>
        ...
        <div className='d-flex justify-content-between flex-md-row flex-column invoice-spacing mt-0'>
          <div>
            ...
            <h3 className='text-primary invoice-logo'>Berexia Consulting</h3>
            <CardText className='mb-25'>Rue Soumaya, résidence Shérazade 3</CardText>
            <CardText className='mb-25'>5ème étage n°22 Palmiers,Casablanca</CardText>
            <CardText className='mb-0'>contactma@berexia.com8</CardText>
          </div>
          <div className='mt-md-0 mt-2'>
            <h4 className='invoice-title'>
              Facture <span className='invoice-number'>#{data.invoice.id}</span>
            </h4>
      ...
      <CardBody className='invoice-padding pt-0'>
        <Row className='invoice-spacing'>
          <Col className='p-0' lg='8'>
            <h6 className='mb-2'>Facture pour:</h6>
          ...
          <Col className='p-0 mt-xl-0 mt-2' lg='4'>
            <h6 className='mb-2'>details de paiement</h6>
            <table>
              <tbody>
                <tr>
      ...
      <Table responsive>
        <thead>
          <tr>
            <th className='py-1'>Liste de produit</th>
        ...
        <tbody>
          <tr>
            <td className='py-1'>
              <p className='card-text font-weight-bold mb-25'>BAGUETTES D'ANGLES </p>
          ...
          <tr className='border-bottom'>
            <td className='py-1'>
              <p className='card-text font-weight-bold mb-25'>FIL A PAILLE JP12 DIAM</p>
              <p className='card-text text-nowrap'>1,80 MM</p>
            </td>
            <td className='py-1'>
              <span className='font-weight-bold'>$60.00</span>
            </td>
        ...
        <Row className='invoice-sales-total-wrapper'>
          <Col className='mt-md-0 mt-3' md='6' order={{ md: 1, lg: 2 }}>
            <CardText className='mb-0'>
              <span className='font-weight-bold'>Vendeur</span> <span className='ml-75'>Alfie Solomons</span>
            </CardText>
          </Col>
      ...
      <CardBody className='invoice-padding pt-0'>
        <Row>
          <Col sm='12'>
            ...
            <span>
              Ce fut un plaisir de travailler avec vous et votre équipe. Nous espérons que vous nous garderez à l'esprit pour les futurs projets indépendants. Merci!
            </span>
          </Col>
        </Row>
      </CardBody>
